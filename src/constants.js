...
export const variableGroups = [
    {
        ...
        fields: [
            { key: 'psArea', label: 'พื้นที่พื้น PS (แผ่นพื้นสำเร็จ) (ตร.ม.)', tooltip: 'พื้นที่ที่ใช้แผ่นพื้นสำเร็จรูปวาง' },
            { key: 'gsArea', label: 'พื้นที่พื้น GS (ถมทรายแล้วเท) (ตร.ม.)', tooltip: 'พื้นที่พื้นคอนกรีตวางบนดิน (Slab on Ground)' },
            { key: 'sArea', label: 'พื้นที่พื้น S (หล่อในที่) (ตร.ม.)', tooltip: 'พื้นที่พื้นคอนกรีตหล่อในที่ (Slab on Beam) เช่น ห้องน้ำ ระเบียง' },
            ...
            { key: 'slabOnGroundThickness', label: 'ความหนาพื้น SOG/GS (ม.)', tooltip: 'ความหนาของพื้นคอนกรีตวางบนดิน (Slab on Ground) ค่าเฉลี่ยคือ 0.10' },
    ...
    },
    {
        ...
        fields: [
            ...
            { key: 'wallType', label: 'ประเภทผนังหลัก', type: 'select', options: [
                ...
                { value: 'redbrick_7_5', label: 'อิฐมอญ (7.5 ซม.)' },
                { value: 'redbrick_17_5', label: 'อิฐมอญ (17.5 ซม.)' },
                { value: 'block_7_5', label: 'อิฐบล็อก (7.5 ซม.)' },
                { value: 'block_17_5', label: 'อิฐบล็อก (17.5 ซม.)' },
                { value: 'tanbrick', label: 'อิฐบล็อก TAN-BRICK' }
            ], tooltip: 'เลือกระบบผนังหลักของโครงการ ระบบจะกรองรายการวัสดุและคำนวณจำนวนก้อนให้อัตโนมัติ' },
            { key: 'plasterThickness', label: 'ความหนาปูนฉาบ (ม.)', tooltip: 'ความหนาปูนฉาบผนัง โดยทั่วไปจะอยู่ที่ประมาณ 0.0125 ม. (1.25 ซม.)' },
